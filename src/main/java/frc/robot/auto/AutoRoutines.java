...
import frc.robot.subsystems.drive.commands.SnapCommand;
...
public final class AutoRoutines {
	public static Command testSnap() {
		return new SnapCommand(new Pose2d(5, 5, Rotation2d.kCCW_Pi_2), Rotation2d.kCCW_Pi_2);
	}
